...
@SourceType(value = "BingAdsARP", label = "BingAds",uiConfig = "bingads-layout.json")
public class BingAdsConf extends AbstractArpConf<BingAdsConf> {
  private static final String ARP_FILENAME = "arp/implementation/bingads-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.bingads.BingAdsDriver";
